...
<html>
 ...
 -->
                <div class="form-group">
                    <select class="form-control js-example-basic-single" name="note" oninvalid="this.setCustomValidity('Pilih Cluster')" oninput="setCustomValidity('')">
                        <option value="" selected disabled hidden>Catatan</option>
                        <option value="Rumah Kosong">Rumah Kosong</option>
                        <option value="Rumah Tidak Berpenghuni">Rumah Tidak Berpenghuni</option>
                        <option value="Rumah Tidak Terjangkau">Rumah Tidak Terjangkau</option>
                    </select>
                </div>
                ...
                <div class="alert alert-success alert-dismissible fade show d-none my-alert" role="alert">
                    ...
                    Data yang kamu input telah berhasil disimpan.
